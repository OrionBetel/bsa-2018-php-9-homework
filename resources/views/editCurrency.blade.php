...
@section('heading')
    <h1 class="display-4 text-center">Edit {{ $currency['title'] }}</h1>
@endsection

@section('content')
<div class="card">
    <div class="card-body">
        <form role="form" method="POST" action="{{ route('show-edit-form', ['id' => $currency['id']]) }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('title') ? ' has-error' : '' }}" 
                        value="{{ old('title') ?? $currency['title'] }}" id="title" type="text" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('short_name') ? ' is-invalid' : '' }}"
                        value="{{ old('short_name') ?? $currency['short_name'] }}" id="short_name"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('logo_url') ? ' is-invalid' : '' }}" 
                        value="{{ old('logo_url') ?? $currency['logo_url'] }}" id="logo_url"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('price') ? ' is-invalid' : '' }}"
                        value="{{ old('price') ?? $currency['price'] }}" id="price" type="text" 
                        name="price">
                </div>
            </div>
